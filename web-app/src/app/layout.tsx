...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/platform/favicon.ico', sizes: 'any' },
      { url: '/platform/icons/icon-32.png', sizes: '32x32', type: 'image/png' },
      { url: '/platform/icons/icon-16.png', sizes: '16x16', type: 'image/png' },
    ],
    apple: [
      { url: '/platform/icons/apple-touch-icon.png', sizes: '180x180' },
    ],
    other: [
      { rel: 'mask-icon', url: '/platform/icons/safari-pinned-tab.svg', color: '#5B21B6' },
    ],
  },
