...
export interface CountryCode {
  code: string; // ISO country code (CZ, US, etc.)
  name: string;
  dialCode: string; // +420, +1, etc.
...
// Default country (Czech Republic)
export const DEFAULT_COUNTRY = COUNTRY_CODES.find(c => c.code === 'CZ') || COUNTRY_CODES[9];
