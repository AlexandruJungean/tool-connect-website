...
// Dynamic words for the hero title
const dynamicWordsEN = ['services', 'professionals', 'solutions', 'experts']
const dynamicWordsCS = ['služby', 'profesionály', 'řešení', 'odborníky']
...
export default function LandingPage() {
  ...
  // Rotate dynamic words
  useEffect(() => {
    const interval = setInterval(() => {
      setIsAnimating(true)
      setTimeout(() => {
        setDynamicWordIndex((prev) => (prev + 1) % dynamicWordsEN.length)
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Tool - {language === 'cs' ? 'Všechny' : 'All the'}{' '}
                <span 
                  className={cn(
                    "inline-block text-white/90 transition-all duration-300",
                    isAnimating ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0"
                  )}
                >
                  {language === 'cs' ? dynamicWordsCS[dynamicWordIndex] : dynamicWordsEN[dynamicWordIndex]}
                </span>
                {language === 'cs' ? ', které potřebujete.' : ' you need.'}
              </h1>
            ...
            {/* Right - Download Section (improved design) */}
            <div className="hidden lg:flex flex-col items-center">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-[280px]">
                {/* Header */}
                <div className="bg-gray-900 text-white p-4 text-center">
                  <h3 className="font-bold text-base">{t.download.title}</h3>
                </div>
                ...
                <div className="p-4 space-y-2">
                  <a
                    ...
                    className="flex items-center gap-3 bg-gray-900 text-white px-4 py-2.5 rounded-xl hover:bg-gray-800 transition-colors"
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="font-semibold text-sm">{t.download.appStore}</div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="font-semibold text-sm">{t.download.googlePlay}</div>
                    </div>
                  </a>
                  <Link
                    href="/search"
                    className="flex items-center gap-3 bg-primary-600 text-white px-4 py-2.5 rounded-xl hover:bg-primary-700 transition-colors"
                  >
                    <Globe className="w-7 h-7 flex-shrink-0" />
                    <div className="text-left">
                      <div className="text-[10px] opacity-70 leading-none">Try it on the</div>
                      <div className="font-semibold text-sm">{t.download.webBrowser}</div>
                    </div>
                  </Link>
                </div>
                ...
                <div className="bg-gray-50 p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-gray-900 text-sm truncate">{t.download.title}</p>
                    <p className="text-xs text-gray-500">{t.download.scanQR}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:hidden mt-8 flex flex-col items-center gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-sm">
              ...
              <div className="bg-gray-50 p-4 flex items-center gap-4">
                ...
                />
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-gray-900 text-sm">{t.download.title}</p>
                  <p className="text-xs text-gray-500">{t.download.scanQR}</p>
                </div>
              </div>
            </div>
